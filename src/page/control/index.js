...
class App extends Component {
    ...
    // }
    render() {
        let {down,stop,transform,translation} = this.props;
        ...
        const content = (
            <div className="control" style={{marginTop: "79px"}}>
                ...
                <div onClick={()=>translation(1)} className="_1pg0 _23pZ _2TvZ" style={{top: "90px", left: "284px"}}><i className=""></i><em style={{transform: "translate(60px, -12px) rotate(270deg) scale(1, 2)"}}></em><span
                    className="">左移</span></div>
                <div onClick={()=>translation(-1)} className="_1pg0 _23pZ _2TvZ" style={{top: "90px", left: "464px"}}><i className=""></i><em style={{transform: "translate(-60px, -12px) rotate(90deg) scale(1, 2)"}}></em><span
                ...
                <div onClick={stop} className="_1pg0 RBZg oW6K" style={{top: "0px", left: "16px"}}><i className=""></i><span className="">暂停(P)</span></div>
            </div>
        )
